...
function writeCookies(erase = false) {
    var keep = "expires=Thu, 31 Dec 2015 12:00:00 GMT", 
        remove = "expires=Thu, 01 Jan 1977 00:00:01 GMT", 
        value, expire;
    ...
    saveKeys(space, function (object, key) {
        ...
        document.cookie = "space." + key + "=" + value + "; " + expire;
    });
    saveKeys(planet.visible, function (object, key) {
        ...
        document.cookie = "planet.visible." + key + "=" + value + "; " + expire;
    });
    saveKeys(planet.fleet, function (object, key) {
        ...
        document.cookie = "planet.fleet." + key + "=" + value + "; " + expire;
    });
    saveKeys(planet.population, function (object, key) {
        ...
        document.cookie = "planet.population." + key + "=" + value + "; " + expire;
    });
    
    if (space.running === true && space.globalWindow) {
        space.globalWindow.setTimeout(writeCookies, 5000);
    }
}
...
function reset() {
    space.running = false;
    writeCookies(true);
    $("#buildBattery").addClass("button_hidden");
    $("#buildBattery10").addClass("button_hidden_numeric");
    $("#buildBattery50").addClass("button_hidden_numeric");
    $("#batteryResearch").addClass("button_hidden");
    $("#buildShield").addClass("button_hidden");
    $("#buildShield10").addClass("button_hidden_numeric");
    $("#buildShield50").addClass("button_hidden_numeric");
    $("#shieldResearch").addClass("button_hidden");
    $("#shipResearch").addClass("button_hidden");
    $("#buildShip").addClass("button_hidden");
    $("#buildShip10").addClass("button_hidden_numeric");
    $("#buildShip50").addClass("button_hidden_numeric");
    $("#irridiumResearch").addClass("button_hidden");
    $("#dilithiumResearch").addClass("button_hidden");
    $("#tritaniumResearch").addClass("button_hidden");
    $("#attackPlanet").addClass("button_hidden");
    $("#start").html("");
    init();
}
